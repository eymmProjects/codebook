...
export const Faq = () => {
  ...
  return (
    <section className="my-10 p-7 border rounded dark:border-slate-700 shadow-sm">
      <h1 className="text-2xl text-center font-semibold dark:text-slate-800 mb-3 underline underline-offset-8">
        Question in mind?
      </h1>
      <div
        className=""
        ...
        data-active-classes="bg-white dark:bg-gray-900 dark:text-slate-800 dark:text-slate-800"
        data-inactive-classes="text-gray-500 dark:text-gray-400 dark:text-slate-800"
      >
        {faqs.map((faq) => (
