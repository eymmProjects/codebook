  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-800 items-center">
        <div className="text my-5">
            ...
            <p className="text-2xl my-7 px-1 dark:text-slate-500">CodeBook is the world's most popular and authoritative source for computer science ebooks. Find ratings and access to the newest books digitally.</p>
